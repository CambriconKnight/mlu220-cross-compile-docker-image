...
//    char *func_name;
//    int func_name_size;
//    printf("cnrtGetFunctionSymbol......\n");
//    //cnrtGetFunctionSymbol(model, 0,&func_name, &func_name_size);
//    CNRT_CHECK(cnrtGetFunctionSymbol(model, 0, &func_name, &func_name_size));
//    printf("func_name:%s func_name_size:%d \n",func_name,func_name_size);
//    free(func_name);
